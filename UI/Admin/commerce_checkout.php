                            ...
                            <div class="col-xl-9" id="scroll_path">
                                            ...
                                            <div class="au-breadcrumb-content">
                                                <div class="au-breadcrumb-left">
                                                    ...
                                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                                        ...
                                                        <li class="list-inline-item">Exits</li>
                                                    </ul>
                                                </div>
                                ...
                                ************************************** -->
                                ...
                                <div class="page-content" style="margin-top: 0px;">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3 class="title-5 m-b-0">All Exits mouvements</h3>
                                            <small style="color: #999;">Money spent with justification</small>
                                          ...
                                          <form  action="" method="post" novalidate="novalidate">
                                            <div class="table-data__tool">
                                                <div class="table-data__tool-left">
                                                    ...
                                                    <div class="rs-select2--light rs-select2--sm" style="width: 200px;">
                                                        <div class="form-group boxShadow">
                                                            <input id="cc-exp" name="receiverName" type="text" class="cc-exp" value="" data-val="true" data-val-required="Please enter the quantity of the item" data-val-cc-exp="Please enter a valid month and year" placeholder="Receiver name" autocomplete="cc-exp" style="border: none;padding: 9px 10px;border-radius: 3px; font-size: 14px;outline: none;color: #777">
                                                            <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="table-data__tool-right">
                                                    <button type="submit" name="submit" class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#largeModal">
                                            ...
                                            <div class="##" style="margin-right: 7px;">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <div class="form-group">
                                                                <label for="cc-exp" class="control-label mb-1">Money Amount <small class="smallComent">the amount of money...</small></label>
                                                                <input id="myInputForm" name="moneyAmount" type="number" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="_" autocomplete="cc-exp">
                                                                <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="cc-payment" class="control-label mb-1">Motif <small class="smallComent">a little comment...</small></label>
                                                        <textarea id="myInputForm" rows="5" name="motif" type="text" class="form-control" aria-required="true" placeholder="_" aria-invalid="false"></textarea>
                                                    </div>
                                                </div>
                                                <!-- </div>
                                                </div> -->
